					...
					<div class="col-lg-6 col-md-12">
						<div class="padding">
							...
							<div class="form-group">
									<label class="d-block" for="regfirstname">
										First Name
										
									</label>
									<input type="text" id="regfirstname" class="form-control rounded" data-parsley-pattern="/^[a-zA-Z\s]+$/" required placeholder="First Name" tabindex = "1" > 
								</div>
								<div class="form-group">
									<label class="d-block" for="reglastname">
										First Name
										
									</label>
									<input type="text" id="reglastname" class="form-control rounded" data-parsley-pattern="/^[a-zA-Z\s]+$/" required placeholder="Last Name" tabindex = "2" > 
								</div>
								<div class="form-group">
								...
								<div class="form-group text-right">
									<div class="float-left">
										<a href="index.php">Login with personal account here</a>
									</div><br>
									<div class="float-left ">
										<a href="companyPortal.php">Already have an account? Login here</a>
									</div>
