                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li class="nav-item">
                        <a href="../forum.php" class="nav-link link-dark align-middle px-0">
                            <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Public Forum</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="../companyForum.php" class="nav-link link-dark align-middle px-0">
                            <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline">Company Forum</span>
                        </a>
                    </li>
                    <li class="nav-item">
