...
if (@$_GET["action"] == "update"){
	$sql_cat = "SELECT commentID, postID, accID, message FROM comments WHERE commentID = ?";
            ...
            <div class="col-sm-12">
				<table border="1" class="table table-striped ">
					...
					<tbody>
						...
						<?php $ctr++; ?>
						<tr>
							<td> <a href="comments.php?action=update&commentID=<?php echo $get_comment["commentID"] ?>"> 
							Update</a> /
							<a href="process.comments.php?action=delete&commentID=<?php echo $get_comment["commentID"] ?>">
							Delete</a>
							</td>
