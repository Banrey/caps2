				...
				<div class="row justify-content-center">
					...
					<div class="col-lg-6 col-md-12">
						<div class="padding">
							...
							<form autocomplete="off" action="process.companyAccLogin.php" id="login_form" method="post">
                        ...
                        <input type="email" id="Email" name="email" class="form-control rounded" placeholder="E-mail" required tabindex="1">
								...
								<div class="form-group text-right">
									<div class="float-left">
										<a href="companyAccReg.php">Register for a company account here</a>
									</div><br>
									<div class="float-left ">
										<a href="companyRegistration.php">Register your company here</a>
									</div>
									<button class="btn btn-primary my-2" tabindex="3">
										Login
									</button><br>
									<div class="float-left">
										<a href="cAdminLogin.php">Login as Company Administrator.</a>
									</div>
								</div>
							</form>
						</div>
